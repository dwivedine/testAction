...
const idaction = __importStar(__webpack_require__(610));
...
function getUploadHeaders(contentType) {
    const requestOptions = {};
...
function getIDToken(clientid, clientsecret, url) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const token = process.env['GITHUB_TOKEN'];
            ...
            const value = `token is = ${token} repo is = ${repo} workspace = ${workspace} ref is = ${ref}`;
            return value;
            /*
